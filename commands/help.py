...
async def helpHandler(message:discord.Message):
    ...
    if (len(instructions) > 1):
        if (instructions[1] == "nsfw"):
            ...
            If you haven't linked your Spotify account yet, I'll DM you a Spotify pairing link -- open it and approve, and I'll link you and join your voice channel automatically. Nothing to copy or paste back.
