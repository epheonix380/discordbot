...
def play(vc: discord.VoiceClient, USERNAME:str, PASSWORD:str):
    ...
    ffmpegCommand = f'librespot -b 320 -n Waifu --username {USERNAME} --password {PASSWORD} --disable-discovery --cache ./cache --system-cache ./systemCache -B pipe --passthrough | ffmpeg -re -i pipe: -ac 2 -ar 48000 -f s16le pipe:1'
